...
Mobile.tap(findTestObject('Mobile Update Profile/android.widget.ImageView0'), 0)

Mobile.tap(findTestObject('Mobile Update Profile/android.widget.ImageView0 (1)'), 0)

Mobile.setText(findTestObject('Mobile Update Profile/android.widget.EditText0 - Type something'), '175', 0)

Mobile.setText(findTestObject('Mobile Update Profile/android.widget.EditText0 - Type something (1)'), '60', 0)

Mobile.setText(findTestObject('Mobile Update Profile/android.widget.EditText0 - Type something (2)'), '087771717105', 0)

Mobile.setText(findTestObject('Mobile Update Profile/android.widget.EditText0 - Type something (3)'), 'Jakarta Indonesia', 
    0)

Mobile.tap(findTestObject('Mobile Update Profile/android.widget.TextView0 - Simpan'), 0)
